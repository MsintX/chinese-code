...
<p align="center">
<img src="https://cdn.phototourl.com/free/2026-08-07-a4024ebb-a0ef-4509-823d-c323464b7f07.png" width="150" alt="Logo"/>
</p>
...
[![GitHub release (latest by date)](https://img.shields.io/github/v/release/MsintX/chinese-code)](https://github.com/MsintX/chinese-code/releases) ![GitHub Release Date](https://img.shields.io/github/release-date/MsintX/chinese-code) 
![GitHub All Releases](https://img.shields.io/github/downloads/MsintX/chinese-code/total) 
![GitHub stars](https://img.shields.io/github/stars/MsintX/chinese-code?style=flat) 
![GitHub forks](https://img.shields.io/github/forks/MsintX/chinese-code)
![GitHub issues](https://img.shields.io/github/issues/MsintX/chinese-code)
![GitHub license](https://img.shields.io/github/license/MsintX/chinese-code)
![GitHub last commit](https://img.shields.io/github/last-commit/MsintX/chinese-code)

`ChineseCode.hpp`是一个使用宏和模板函数实现中文编程的头文件。
...
本项目/文件遵循 **GPLv3-or-later**（GNU 通用公共许可证第 3 版或任何后续版本）协议。
```LICENSE - English(United States)
...
中文：
``` LICENSE - Chinese(Simplified, Mainland China)
========GPLv3 协议（Simplified）========
...
```
> 简略摘要不代表许可全文。要了解详细条款，请阅读[许可证文件](./LICENSE)，一切许可以英文原文为准。
...
## 关于我们
"HitBits Lab"是由[MsintX](https://Github.com/MsintX)创建的非商业团队。我们将持续产出应用、游戏（计划中）以及各种奇奇怪怪的想法。你也可以去[官网](https://hitbits.xyz/)了解更多
